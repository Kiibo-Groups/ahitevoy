...
aria-controls="lang{{ $lng['id'] }}" aria-selected="false"><img src="{{ asset('public/upload/language/'.$lng['icon']) }}" height="20"> {{ $lng['name'] }}</a>
</li>
...
aria-controls="home" aria-selected="true"><img src="{{ asset('public/upload/en.png') }}" height="20"> English</a>
</li>
