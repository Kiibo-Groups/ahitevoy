            ...
            <div class="col-12 col-lg-6 order-2 order-lg-1 position-relative d-flex align-items-center bg-1">
                <div class="login-content text-center text-lg-left">
                    ...
                    <div class="title d-inline-block mb-4">
                        <h3 class="mb-3 heading">Bienvenido(a)</h3>
                    ...
                    <form class="needs-validation" action="{{ $form_url }}" method="post">
                       ...
                       <div class="row">
                           <div class="col-12">
                               <input class="form-control" type="email" name="username" placeholder="Correo electrónico" required="required">
                           </div>
                           <div class="col-12">
                ...
                <div class="bottom-mini-nav">
                    <div class="row no-gutters">
                        <div class="col-12 col-lg-12 simple-navbar d-flex align-items-center justify-content-start">
                            <nav class="navbar">
                                <a class="nav-link link" href="#" target="_blank">Descargar Apps</a>
                                <a class="nav-link link" href="https://ahitevoy.com" target="_blank">Acerca de nosotros</a>
                            </nav>
                        </div>
                    </div>
                </div>
