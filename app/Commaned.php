...
class Commaned extends Authenticatable
{
    ...
    */
    ...
    public function addNewWhatsapp($data, $add)
    {
        ...
        $msg .= "Hola, Vengo de AhiTeVoy Delivery." . $ddnl;
    ...
    */
    ...
    function setStaffEvent($event_id, $dboy_id)
    {
        ...
        if ($event->d_boy != 0) {
            ...
            $notify->sendPushD("Nuevo servicio", "Nueva solicitud de reparto, revisa los detalles.", $dboy_id);
    ...
    function delStaffEvent($event_id)
    {
        ...
        if ($event->d_boy != 0) {
            ...
            if ($event->status == 0) {
                ...
                $notify->sendPush($title, $msg, $event->user_id);
