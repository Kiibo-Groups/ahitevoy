    ...
    */
    ...
    public function menuItem($id, $type, $value)
    {
        ...
        foreach ($cates as $cate) {
            ...
            $data[] = [
                'id' => $cate->category_id,
                'sort_no' => $this->getLangCate(
                    $cate->category_id,
                    $_GET['lid']
                )['sort_no'],
                'cate_name' => $this->getLangCate(
                    $cate->category_id,
                    $_GET['lid']
                )['name'],
                'items' => $item
    ...
    */
    ...
    public function forgot($data)
    {
        ...
        if (isset($res->id)) {
            ...
            $para = $data['email'];
            $asunto = 'Codigo de acceso - AhiTeVoy Business';
    ...
    {
        $res = User::where('id', $data['user_id'])->where('otp', $data['otp'])->first();
    ...
    {
        $res = User::where('id', $data['user_id'])->first();
